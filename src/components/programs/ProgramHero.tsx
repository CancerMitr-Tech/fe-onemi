...
export default function ProgramHero({ title, subtitle, description }: ProgramHeroProps) {
  return (
    <section className="bg-[#C9A87C] min-h-[60vh] flex items-center py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <p className="text-[#E85D04] font-semibold mb-3 text-sm uppercase tracking-wider">
          OneMi Program
        </p>
        <h1 className="text-4xl sm:text-5xl font-bold text-[#1A1A2E] mb-4">{title}</h1>
